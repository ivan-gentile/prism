#!/usr/bin/env python3
"""
Test script for PRISM Clinician Agent only
Uses the PRISMAgentSystem but focuses only on the clinician agent
"""
...
async def test_clinician_agent_only():
    """Test only the clinician agent with the provided patient data"""
    
    print("=" * 80)
    print("TESTING PRISM CLINICIAN AGENT ONLY")
    print("=" * 80)
...
async def main():
    ...
    success = await test_clinician_agent_only()
